		...
		>
			...
			<div className="flex flex-col lg:flex-row items-center gap-10">
				...
				<div className="items-center sm:items-start flex flex-col">
					<h1 className="text-6xl md:text-7xl lg:text-8xl text-center lg:text-left font-extralight">
						Hello! I'm <h1 className="font-merriweather font-bold underline decoration-yellow-500 mb-6">Rafy Akbar</h1>
					</h1>
