...
const Experience = ({ product, index }) => {
  return (
    <div className="bg-white dark:bg-neutral-950 border rounded-3xl p-7 h-56 flex flex-col justify-between">
...
const Timeline = ({ heading }) => {
  ...
  return (
    <div
      className="py-12 px-12 scroll-mt-12 dark:text-white min-[800px]:w-[750px] mx-4 min-[800px]:mx-auto"
      id={timelineID}
    >
      <h2 className="font-black text-3xl tracking-tight text-center mb-12">
        {heading}
      </h2>
      <div className="grid grid-cols-1 justify-center min-[800px]:grid-cols-2 gap-4">
