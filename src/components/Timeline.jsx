...
const Experience = ({ product, index }) => {
  return (
    <div className="bg-white dark:bg-neutral-900 rounded-3xl w-[28rem] p-7 h-56 flex flex-col justify-between transform transition-transform hover:scale-105 ease-out shadow-sm">
...
const Timeline = ({ heading }) => {
  ...
  return (
    <div
      className="py-12 px-5 scroll-mt-12 dark:text-white lg:w-[1024px] sm:mx-auto"
      id={timelineID}
    >
      <h2 className="font-black text-3xl tracking-tight text-center mb-12">
        {heading}
      </h2>
      <div className="flex flex-wrap justify-center min-[800px]:grid-cols-2 gap-6">
